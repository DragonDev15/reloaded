 ...
 */
 class Collection extends Map {
    ...
    first(amount) {
        ...
        if (typeof amount !== 'number') throw new TypeError('The count must be a number.');
        if (!Number.isInteger(count) || amount < 1) throw new RangeError('The count must be an integer greater than 0.');
