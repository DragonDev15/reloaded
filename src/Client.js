...
class Client extends EventEmitter {
     ...
     */
    async connect() {
        this.emit("debug", `Provided token: ${this.token}`);
        try {
    ...
    sendMessage(channelID, data) {
        return new Promise((resolve, reject) => {
            ...
            if (!channelID) reject(new Error("No channel id was provided!"));
            ...
            const url = `${this.constants.BASE_URL}${this.constants.API_VERSION}${this.constants.CHANNEL(channelID)}/messages`;
            this.rest.post(url, {
                headers: {
